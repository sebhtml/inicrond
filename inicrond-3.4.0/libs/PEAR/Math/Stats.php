...
// +----------------------------------------------------------------------+
//
// $Id: Stats.php 87 2006-01-01 02:20:14Z sebhtml $
//

include_once PEAR_PATH."PEAR.php";
...
class Math_Stats {/*{{{*/
    ...
    function skewness() {/*{{{*/
        ...
        if (isset ($this->_calculatedValues['skewness']))
        {
    ...
    function kurtosis() {/*{{{*/
        ...
        if (isset ($this->_calculatedValues['kurtosis']))
        {
    ...
    function quartileVariationCoefficient() {/*{{{*/
        if (!array_key_exists('quartileVariationCoefficient', $this->_calculatedValues)) {
            ...
            $q1 = $quart['25'];
            $d = $q3 - $q1;
            $s = ($q3 + $q1) ? ($q3 + $q1): 1;//this class is hacked,
            //is the tdown not give greater than 1, use 1...
