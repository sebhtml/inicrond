 ...
 * @version    CVS: $Id: GD.php 8 2005-09-13 17:44:21Z sebhtml $
 ...
 */
require_once PEAR_PATH.'Image/Graph/Driver.php';
...
class Image_Graph_Driver_GD extends Image_Graph_Driver
{
    ...
    {
        include_once PEAR_PATH.'Image/Graph/Color.php';
    ...
    function splineEnd($connectEnds = true, $fillColor = false, $lineColor = false)
    {
        ...
        include_once PEAR_PATH.'Image/Graph/Tool.php';
