 ...
 * @version    CVS: $Id: Graph.php 8 2005-09-13 17:44:21Z sebhtml $
 ...
 */
require_once PEAR_PATH.'Image/Graph/Config.php';

/**
 * Include file Image/Graph/Element.php
 */
require_once PEAR_PATH.'Image/Graph/Element.php';

/**
 * Include file Image/Graph/Constants.php
 */
require_once PEAR_PATH.'Image/Graph/Constants.php';

/**
 * Include file Image/Graph/Color.php
 */
require_once PEAR_PATH.'Image/Graph/Color.php';
...
class Image_Graph extends Image_Graph_Element
{
    ...
    function &Image_Graph($params, $height = false, $createTransparent = false)
    {
        ...
        if ($this->_driver == null) {
            include_once PEAR_PATH.'Image/Graph/Driver.php';
            $this->_driver =&
    ...
    function &factory($class, $params = null)
    {
        ...
        include_once PEAR_PATH.str_replace('_', '/', $class) . '.php';
    ...
    {
        include_once PEAR_PATH."Image/Graph/Layout/$layout.php";
