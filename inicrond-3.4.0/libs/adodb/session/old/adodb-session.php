...
function adodb_sess_gc($maxlifetime) 
{
	...
	if ($ADODB_SESS_CONN->dataProvider === 'oci8') $query = 'select  TO_CHAR('.($ADODB_SESS_CONN->sysTimeStamp).', \'RRRR-MM-DD HH24:MI:SS\') from '. $ADODB_SESSION_TBL;
	else $query = 'select '.$ADODB_SESS_CONN->sysTimeStamp.' from '. $ADODB_SESSION_TBL;
