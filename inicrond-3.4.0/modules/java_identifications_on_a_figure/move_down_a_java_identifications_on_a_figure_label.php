<?php
/*
    $Id: move_down_a_java_identifications_on_a_figure_label.php 99 2006-01-08 02:49:00Z sebhtml $
...
&& is_teacher_of_cours ($_SESSION['usr_id'], inode_to_course ($inode_id)))
{
    ...
    {
        $java_identifications_on_a_figure_label_id_after = $row['java_identifications_on_a_figure_label_id'] ;
        $order_id_after = $row['order_id'] ;

        $query = '
        update
        '.$_OPTIONS['table_prefix'].'java_identifications_on_a_figure_label
        set
        order_id = '.$order_id_after.'
        where
        ...
        order_id = '.$order_id_current.'
        where
        java_identifications_on_a_figure_label_id = '.$java_identifications_on_a_figure_label_id_after.'
        ' ;
