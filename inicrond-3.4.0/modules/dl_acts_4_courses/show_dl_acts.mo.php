<?php
/*
    $Id: show_dl_acts.mo.php 113 2006-01-18 01:40:20Z sebhtml $
...
if(isset($_GET['usr_id']) && $_GET['usr_id'] != "" && (int) $_GET['usr_id'] && !isset($_GET['join'])
&& $is_in_charge_of_user)
{
    ...
    while ($f = $rs->FetchRow())
    {
        $tableX []= array(retournerHref(__INICROND_INCLUDE_PATH__.
            "modules/dl_acts_4_courses/show_dl_acts.mo.php?usr_id=".$_GET['usr_id'].
            "&file_id=".$f['file_id']."&join", $f['file_name']));
    }
    ...
    && !isset($_GET['join']) && $is_in_charge_of_group)
{
    ...
    while($f = $rs->FetchRow())
    {
        $tableX []= array(retournerHref(__INICROND_INCLUDE_PATH__."modules/dl_acts_4_courses/show_dl_acts.mo.php?group_id=".$_GET['group_id']."&file_id=".$f['file_id']."&join",
        $f['file_name']));
    }
...
(int) $_GET['file_id'] &&
    ...
    || (isset($_GET['usr_id']) && $is_in_charge_of_user)))
{
    $it_is_ok = TRUE;
