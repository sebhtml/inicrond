<?php
/*
    $Id: user_graphics_for_a_course.php 84 2005-12-26 20:31:43Z sebhtml $
...
if(isset($_GET['usr_id']) && $_GET['usr_id'] != "" && (int) $_GET['usr_id'] && is_in_charge_of_user($_SESSION['usr_id'], $_GET['usr_id']))
{
