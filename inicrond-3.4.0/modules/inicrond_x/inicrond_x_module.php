<?php
/*
    $Id: inicrond_x_module.php 88 2006-01-03 21:09:08Z sebhtml $
...
if(isset($_GET['group_id']) && $_GET['group_id'] != "")//analysis all groups querys.
{
    ...
    if($count_groups)
    {
        ...
        foreach($check_those_things AS $a_thing)
        {
            ...
            foreach($parameters AS $parameter => $processing)
            {
                    if($processing && $a_thing["preprocessor"] != "")
                    {
