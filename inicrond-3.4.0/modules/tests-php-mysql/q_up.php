<?php
/*
    $Id: q_up.php 85 2005-12-27 03:22:23Z sebhtml $
...
&& is_teacher_of_cours($_SESSION['usr_id'],question_2_cours($_GET["question_id"])))
{
    ...
    $order_id_avant = $fetch_result["MAX(q_order_id)"];

    if(isset($fetch_result["MAX(q_order_id)"]))//est-ce qu'il y a quelque chose avant.
    {
    ...
    js_redir("edit_a_test_GOLD.php?test_id=".$test_id);
