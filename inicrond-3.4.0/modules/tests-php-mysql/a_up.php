<?php
/*
    $Id: a_up.php 85 2005-12-27 03:22:23Z sebhtml $
...
&& is_teacher_of_cours($_SESSION['usr_id'],answer_2_cours($_GET["answer_id"])))
{
    ...
    $order_id_avant = $fetch_result["MAX(a_order_id)"];

    if(isset($fetch_result["MAX(a_order_id)"]))//est-ce qu'il y a quelque chose avant.
    {
