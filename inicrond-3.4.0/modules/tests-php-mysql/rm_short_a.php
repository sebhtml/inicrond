<?php
/*
    $Id: rm_short_a.php 85 2005-12-27 03:22:23Z sebhtml $
...
if(isset($_GET["short_answer_id"]) && $_GET["short_answer_id"] != ""
&& (int) $_GET["short_answer_id"]
&& is_teacher_of_cours($_SESSION['usr_id'],multiple_short_answer_2_cours($_GET["short_answer_id"])))
{
    $query = "
    SELECT
    question_id
    ...
    WHERE
    short_answer_id=".$_GET["short_answer_id"]."
    ";
