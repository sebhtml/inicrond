<?php
/*
    $Id: edit_post.php 85 2005-12-27 03:22:23Z sebhtml $
...
&& (int) $_GET["forum_message_id"])
{
    ...
    if($_SESSION['usr_id'] == $fetch_result['usr_id'])//éditer
    {
        ...
        && $_POST['forum_message_contenu'] != "")
        {
            ...
            $query = "
            UPDATE ".$_OPTIONS['table_prefix'].$_OPTIONS['tables']['sebhtml_forum_messages']."
            SET
            ...
            js_redir("thread_inc.php?forum_sujet_id=".message2sujet($_GET["forum_message_id"]));
        }
