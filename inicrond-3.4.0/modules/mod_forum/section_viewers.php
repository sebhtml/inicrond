<?php
/*
    $Id: section_viewers.php 85 2005-12-27 03:22:23Z sebhtml $
...
if(isset($_GET["forum_section_id"]) && $_GET["forum_section_id"] != "" && (int) $_GET["forum_section_id"]
&& can_usr_admin_section($_SESSION['usr_id'], ($_GET["forum_section_id"])))
{
    ...
    // titre
    //---------------------
    $module_title = $_LANG['forum_viewers'];
    ...
    $my_groups->group_elm_table = 'sections_groups_view';
    $my_groups->elm_field_name = "forum_section_id";
