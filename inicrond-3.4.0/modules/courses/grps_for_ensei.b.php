<?php
/*
    $Id: grps_for_ensei.b.php 83 2005-12-26 20:28:15Z sebhtml $
...
if (isset ($_GET['cours_id']) && $_GET['cours_id'] != "" && (int) $_GET['cours_id'] && $_SESSION['SUID'])
{
    $module_title = $_LANG['change_groups_cours_for_ensei'];
    ...
    $Group_property_checkbox->elm_field_name = "is_teacher_group";
