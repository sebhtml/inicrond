<?php
/*
    $Id: remove_a_group.php 84 2005-12-26 20:31:43Z sebhtml $
...
&& is_chef_of_group($_SESSION['usr_id'], $_GET['group_id']))
{
        ...
        else
        {
            ...
            $_LANG['remove_group']);//enlever le groupe
        }

        //link.
        $module_content .= "<h3><a href=\"".__INICROND_INCLUDE_PATH__.
            "modules/groups/course_groups_listing.php?&cours_id=$cours_id".
            "\">".$_LANG['course_groups_listing']."</a></h3>";
}
