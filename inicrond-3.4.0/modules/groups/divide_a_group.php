<?php
/*
    $Id: divide_a_group.php 88 2006-01-03 21:09:08Z sebhtml $
...
if (!isset($_GET['stage']))
{
    ...
    {
        if (1 <= $_POST['count_sub_groups'] && $_POST['count_sub_groups'] <= $max_number_of_sub_groups)
        {
...
elseif ($_GET['stage'] == 3)
{
    ...
    else
    {
        ...
        foreach ($_SESSION['array_of_count_student_in_each_sub_groups'] AS $key => $value)
        {
            ...
            $sql = '
            insert into '.$_OPTIONS['table_prefix'].$_OPTIONS['tables']['groups'].'
