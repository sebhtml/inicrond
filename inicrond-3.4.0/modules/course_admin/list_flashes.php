<?php
/*
    $Id: list_flashes.php 87 2006-01-01 02:20:14Z sebhtml $
...
{
    $module_title = $_LANG['list_flashes'];
    ...
    while ($fetch_result = $rs->FetchRow())
    {
        ...
        $fetch_result['chapitre_media_title']." (".$fetch_result['file_name'].")",
