<?php
/*
    $Id: count_course_elements.php 127 2006-01-28 21:50:33Z sebhtml $
...
if(isset($_GET['cours_id']) && $_GET['cours_id'] != "" && (int) $_GET['cours_id'] && is_teacher_of_cours($_SESSION['usr_id'], $_GET['cours_id']))
{
    ...
    $stuffs_to_count = array(
        ...
        "query" => "
        SELECT
        COUNT(".$_OPTIONS['table_prefix'].$_OPTIONS['tables']['inode_elements'].".inode_id) AS count_course_elements
        FROM
        ...
        cours_id=".$_GET['cours_id']."
        and
        ".$_OPTIONS['table_prefix'].$_OPTIONS['tables']['chapitre_media'].".inode_id = ".$_OPTIONS['table_prefix'].$_OPTIONS['tables']['inode_elements'].".inode_id
        "
        ),
        ...
        cours_id=".$_GET['cours_id']."
        and
        ".$_OPTIONS['table_prefix'].$_OPTIONS['tables']['inicrond_images'].".inode_id = ".$_OPTIONS['table_prefix'].$_OPTIONS['tables']['inode_elements'].".inode_id
        "
        ),
