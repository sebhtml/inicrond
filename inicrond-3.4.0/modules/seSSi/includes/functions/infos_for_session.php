<?php
/*
    $Id: infos_for_session.php 87 2006-01-01 02:20:14Z sebhtml $
...
function infos_for_session($session_id, $show_scores, $show_results, $show_dl_acts)
{
    ...
    if($show_scores)
    {
        ...
        if($r["count(score_id)"])//!= 0
        {
            ...
            __INICROND_INCLUDE_PATH__."modules/marks/main.php?session_id=$session_id",
    ...
    if($show_results)
    {
        ...
        {
            $output .= " [ ".retournerHref(
            __INICROND_INCLUDE_PATH__."modules/tests-results/results.php?session_id=$session_id",
