...
//include "modules/tests-php-mysql/includes/functions/score_Xtract.func.php";
include __INICROND_INCLUDE_PATH__."modules/tests-php-mysql/includes/functions/access.function.php";//fonction pour savoir si un étudiant peut faire un test.
...

{
        ...
        result_id,
        ".$_OPTIONS['table_prefix'].$_OPTIONS['tables']['results'].".usr_id,
        usr_name,
        test_name,
	...
	$FROM_WHAT = "
        ...
        AND
        ".$_OPTIONS['table_prefix'].$_OPTIONS['tables']['usrs'].".usr_id=".$_OPTIONS['table_prefix'].$_OPTIONS['tables']['results'].".usr_id
        AND
	".$_OPTIONS['table_prefix'].$_OPTIONS['tables']['results'].".usr_id=".$_OPTIONS['table_prefix'].$_OPTIONS['tables']['online_time'].".usr_id
        ";
        
        
        $base = "../../modules/tests-results/results.php?";
        $it_is_ok = FALSE;
        
	if(isset($_GET['test_id'])AND
	isset($_GET['test_id']) AND
	$_GET['test_id'] != "" AND
	...
	elseif(isset($_GET['usr_id']) AND//un membre...
	$_GET['usr_id'] != "" AND
	(int) $_GET['usr_id'] AND
	!isset($_GET['join']) AND
	...
	)
	{
                ...
                {
                        $WHERE_CLAUSE .= " AND ".$_OPTIONS['table_prefix'].$_OPTIONS['tables']['tests'].".cours_id=".$_GET['cours_id'];
		...
		$it_is_ok = TRUE;
                ...
                $module_content .= "<a href=\"../../modules/tests-results/correl_time_vs_score.php?usr_id=".$_GET['usr_id']."\">".$_LANG['correlation_between_time_and_score']."</a><br />";
                
                
                
                $module_content .= "<a href=\"../../modules/tests-results/normal_dist_img.php?usr_id=".$_GET['usr_id']."\" >".$_LANG['GD_distribution_of_score']."</a><br />";
                
                
                
                $module_content .= "<a href=\"../../modules/tests-results/normal_dist_time_img.php?usr_id=".$_GET['usr_id']."\" >".$_LANG['distribution_of_time']."</a><br />";
                ...
                ".$_OPTIONS['table_prefix'].$_OPTIONS['tables']['tests']."
                WHERE
                ".$_OPTIONS['table_prefix'].$_OPTIONS['tables']['results'].".usr_id=".$_GET['usr_id']."
                AND
		...
		if(isset($_GET['cours_id']) AND
                ...
                {
                        $query .= " AND ".$_OPTIONS['table_prefix'].$_OPTIONS['tables']['tests'].".cours_id=".$_GET['cours_id'];
                ...
                while(  $f = $rs->FetchRow())
                {
                        ...
                        {
                                $tableX []= array(retournerHref("../../modules/tests-results/results.php?usr_id=".$_GET['usr_id']."&test_id=".$f['test_id']."&join",
                                $f['test_name']));
...
is_in_charge_of_user($_SESSION['usr_id'], session_id_to_usr($_GET['session_id']))
	...
	)
	{
		...
		$it_is_ok = TRUE;
                ...
                AND
                ".$_OPTIONS['table_prefix'].$_OPTIONS['tables']['results'].".usr_id=".$_OPTIONS['table_prefix'].$_OPTIONS['tables']['groups_usrs'].".usr_id
                AND
                ".$_OPTIONS['table_prefix'].$_OPTIONS['tables']['tests'].".test_id=".$_OPTIONS['table_prefix'].$_OPTIONS['tables']['results'].".test_id
                AND
                time_GMT_start<time_GMT_end	
                ...
                while($f = $rs->FetchRow())
                {
                        if(!isset($already_there[$f['test_id']]))
                        {
                                $tableX []= array(retournerHref("../../modules/tests-results/results.php?group_id=".$_GET['group_id']."&test_id=".$f['test_id']."&join",
                                $f['test_name']));
	...
	if(isset($_GET['start']) AND//par date, avec un intervalle
	$_GET['start'] != "" AND
	(int) $_GET['start'] AND
	...
	)//par date
	{
		...
		$it_is_ok = TRUE;
                ...
                AND
                ".$_OPTIONS['table_prefix'].$_OPTIONS['tables']['tests'].".cours_id = ".$_GET['cours_id']."";
                
                $module_title =  $_LANG['tests-results'];
                
	}
	elseif($_SESSION['SUID'] AND
	!$it_is_ok
	)//toutes les notes.
	{
		$it_is_ok = TRUE;
	...
	'usr_name' => array(
        ...
        if(
        is_in_inode_group(".$_SESSION['usr_id'].", test_id_2_inode_id(\$f[\"test_id\"]))
        ...
        can_usr_check_result(".$_SESSION['usr_id'].", \$f[\"result_id\"])
        ...
        can_usr_check_sheet(".$_SESSION['usr_id'].", \$f[\"result_id\"]) 
