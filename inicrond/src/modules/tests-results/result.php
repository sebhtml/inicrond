...
$is_in_charge_of_user AND

can_usr_check_sheet($_SESSION['usr_id'], $_GET['result_id']) 
...
{
        if(isset($_GET['result_id'])AND
        isset($_GET['result_id']) AND
        $_GET['result_id'] != "" AND
        (int)  $_GET['result_id'] )//voir une examen...
        {
                ...
                $result = $is_in_charge_of_user  ? retournerHref("../../modules/tests-results/results.php?test_id=".$fetch_result['test_id'], $_LANG['tests-results']) : $_LANG['tests-results'];
                ...
                $show_good_answers = ( 
                is_teacher_of_cours($_SESSION['usr_id'], result_2_cours($_GET['result_id']))
                OR
                ...
                if(!$smarty->is_cached($_OPTIONS['theme']."/result.tpl", $cache_id))
                {
                        ...
                        $smarty->assign("usr_link", retournerHref("../../modules/members/one.php?usr_id=".$fetch_result['usr_id'], $fetch_result['usr_name']));	
                        ...
                        function popup(url,w,h)
                        {
                                ...
                                winPop = window.open(url,'pop_up',params);//crÃ©er l'objet winpop hehe
                                winPop.moveTo(0, 0);//met la fenetre en haut Ã  gauche
                        ...
                        while($fetch_result = $rs->FetchRow())  //pop un # numéro d'exercice...
                        {
                                ...
                                if($fetch_result['q_type'] == 0)//multiple choices
                                {
                                        ...
                                        while($fetch_result_2 = $query_result_2->FetchRow())//pop une réponse
                                        {
                                                $answer = array();
                                                ...
                                                if($fetch_result_2["a_checked_flag"])//a - t - il cocher ça ?
                                                {
                                ...
                                elseif($fetch_result['q_type'] == 1)//réponse courte...
                                {
                                        ...
                                        if(preg_match($fetch_result["short_answer"], $fetch_result_2["short_answer"]))//réponse mauvaise
                                        {
                                ...
                                elseif($fetch_result['q_type'] == 2)//question flashiii
                                {
                                        ...
                                        else//l'exercice n'a pas été fait...
                                        {
