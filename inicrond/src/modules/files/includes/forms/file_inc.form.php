...
$my_text->set_name("uploaded_file_title");
$my_text->set_text($_LANG["15"]["source_name"]);
$my_text->validate();
...
$my_text->set_name("uploaded_file_description");
$my_text->set_rows(50);
$my_text->set_cols(40);
$my_text->set_text($_LANG["15"]["source_description"]);
$my_text->validate();
$my_form->add_base($my_text);
...
$my_text->set_text($_LANG["15"]["source_url"]);
$my_text->validate();
$my_form->add_base($my_text);
