...
if (is_teacher_of_cours ($_SESSION['usr_id'], $_GET['cours_id']))

  {
    ...
    elseif (!
	    (((int) $_GET['inode_id_location']) OR $_GET['inode_id_location']
	     == 0))
    {
      $module_content .=  "3";
    }
...

    {
      ...
      $sql = "INSERT INTO
                ...
                ".$_OPTIONS['table_prefix'].$_OPTIONS['tables']['inode_elements']."
                (inode_id_location, content_id, content_type, cours_id)
                VALUES
                (".$_GET['inode_id_location'].", $content_id, 0, $cours_id)
                ";
      $inicrond_db->Execute ($sql);
      ...
      js_redir (__INICROND_INCLUDE_PATH__.
		"modules/courses/inode.php?cours_id=$cours_id&inode_id_location=".
