...
if (isset ($_GET['inode_id']) AND $_GET['inode_id'] != "" AND (int) $_GET['inode_id'])	//check if the get is ok to understand.
  {
	...
	include __INICROND_INCLUDE_PATH__.
	  "includes/class/form/Form.class.php";
	$my_form = new Form ();
	...
	//file_title
	include __INICROND_INCLUDE_PATH__.
	  "includes/class/form/Base.class.php";

	include __INICROND_INCLUDE_PATH__.
	  "includes/class/form/Option.class.php";

	include __INICROND_INCLUDE_PATH__.
	  "includes/class/form/Select.class.php";
	...
	include __INICROND_INCLUDE_PATH__.
	  "modules/courses/includes/functions/drop_down_list_dirs.php";

	include __INICROND_INCLUDE_PATH__.
	  "modules/courses/includes/functions/is_in_dir_relation.php";

	$my_form->
	  add_base (drop_down_list_dirs
		    ($fetch_result22['cours_id'],
		     $fetch_result22['inode_id_location'],
		     $_GET['inode_id']));
	//end of chapter id flag.



	include __INICROND_INCLUDE_PATH__.
	  "includes/class/form/Submit.class.php";
	$my_text = new Submit ();
