...
if (isset ($_GET['cours_id']) AND $_GET['cours_id'] != "" AND (int) $_GET['cours_id'] AND $_SESSION['SUID'])	//enlever un cours
...

  {
	...
	while ($fetch_result = $rs->FetchRow ())
	  {
	    unlink (__INICROND_INCLUDE_PATH__."uploads/".
		    $fetch_result["md5_path"]);
	  }
	...
	include __INICROND_INCLUDE_PATH__.
	  "modules/tests-php-mysql/includes/functions/drop_question.php";
	...
	$tables_to_look = array ('evaluations',
				 ...
				 'sebhtml_moderators',
				 'inode_groups', 'forums_groups_start');
