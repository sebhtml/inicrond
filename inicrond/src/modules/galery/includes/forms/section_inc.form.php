...
$my_text = new Text();
$my_text->set_value($fetch_result["galerie_name"]);
$my_text->set_name("galerie_name");
$my_text->set_text($_LANG["10"]["galerie"]);
$my_text->validate();
$my_form->add_base($my_text);
  
$select = new Select();
$select->set_name("right_add_an_img");
$select->set_text($_LANG["10"]["right_add_an_img"]);
