...
include '../../modules/courses/includes/languages/'.$_SESSION['language'].'/lang.php';
...
)//check if the get is ok to understand.
{
        ...
        {
                $smarty->assign("$link", "<a href=\"../../modules/course_admin/$link.php?&cours_id=".$_GET['cours_id']."\">".$_LANG["$link"]."</a>");
