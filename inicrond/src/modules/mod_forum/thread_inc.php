...
)
{
	...
	if($_OPTIONS['smarty_cache_config']['mod_forum']["thread.tpl"])// != 0
        {
                $smarty->caching = 1;
        ...
        if(!$smarty->is_cached($_OPTIONS['theme']."/thread.tpl", $cache_id))
        {
                ...
                peut_il_replier($_SESSION['usr_id'], $_GET["forum_sujet_id"])
                ...
                */
                ...
                while($fetch_result = $rs->FetchRow())
                {
                        ...
                        $posts[$i]["usr_link"] = retournerHref("../../modules/members/one.php?usr_id=".$fetch_result['usr_id'], 
