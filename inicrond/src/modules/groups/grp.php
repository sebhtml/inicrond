...
)
{
	...
	$rs = $inicrond_db->Execute($query);
        ...
        $group['graphics_for_a_group'] = "<a href=\"".__INICROND_INCLUDE_PATH__."modules/inicrond_x/graphics_for_a_group.php?group_id=".$fetch_result['group_id']."\">".$_LANG['graphics_for_a_group']."</a>";
        
        $course_infos =  get_cours_infos($fetch_result['cours_id']);   
        $smarty->assign('course_infos', $course_infos);
        
        
        $group['course_groups_listing'] = "<a href=\""."course_groups_listing.php?cours_id=".$fetch_result['cours_id']."\">".$_LANG['course_groups_listing']."</a>";
        
        $group['seSSi'] = retournerHref(__INICROND_INCLUDE_PATH__."modules/seSSi/one.php?group_id=".$_GET['group_id'], $_LANG['seSSi']);
        
        $group['get_group_emails'] = retournerHref("get_group_emails.php?group_id=".$_GET['group_id'], $_LANG['get_group_emails']);
        
        $group['marks'] = retournerHref(__INICROND_INCLUDE_PATH__."modules/marks/main.php?group_id=".$_GET['group_id'], $_LANG['marks']);
        
        $group['tests_results'] = retournerHref(__INICROND_INCLUDE_PATH__."modules/tests-results/results.php?group_id=".$_GET['group_id'], $_LANG['tests-results']);
        
        $group['dl_acts_4_courses'] = retournerHref(__INICROND_INCLUDE_PATH__."modules/dl_acts_4_courses/show_dl_acts.mo.php?group_id=".$_GET['group_id'], $_LANG['dl_acts_4_courses']);
	...
	is_chef_of_group($_SESSION['usr_id'], $_GET['group_id']) 
		...
		$_LANG['remove_group']);
                ...
                $group['update_group_password'] = retournerHref("update_group_password.php?group_id=".$_GET['group_id'],
		$_LANG['update_group_password']);
	...
	ORDER BY usr_nom ASC";
        ...
        {
                $group["users"] []= array(
                "usr_link" => __INICROND_INCLUDE_PATH__."modules/members/one.php?usr_id=".$fetch_result['usr_id']."&cours_id=$cours_id",
