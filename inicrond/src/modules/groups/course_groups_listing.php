...
)//check if the get is ok to understand.
{
	...
	while($fetch_result = $rs->FetchRow())
	{
                ...
                "<a href=\"".__INICROND_INCLUDE_PATH__."modules/groups/grp.php?&group_id=".$fetch_result['group_id']."\">
		".$fetch_result['group_name']."
		</a>"
		,
                $fetch_result['default_pending'] ? $_LANG['yes']: "<b><span style=\"color: red;\">".$_LANG['no']."</span></b>",
                "<a href=\"".__INICROND_INCLUDE_PATH__."modules/groups/edit_a_group.php?&group_id=".$fetch_result['group_id']."\">
		<img border=\"0\" src=\"".__INICROND_INCLUDE_PATH__."modules/courses/templates/inicrond_default/images/b_edit.png\" />
		</a>"
                );
	}
