...
if(isset($_GET['join']) )//join the query with a usr or a group...
{
	...
	$is_in_charge_of_user
		...
		$module_content .= "<a href=\"../../modules/marks/time_vs_score_img.php?usr_id=".$_GET['usr_id']."&chapitre_media_id=".$_GET['chapitre_media_id']."\" >".$_LANG['correlation_between_time_and_score']."</a><br />";
		
                $module_content .= "<a href=\"../../modules/marks/normal_dist_img.php?usr_id=".$_GET['usr_id']."&chapitre_media_id=".$_GET['chapitre_media_id']."\" >".$_LANG['GD_distribution_of_score']."</a><br />";
                
                
                $module_content .= "<a href=\"../../modules/marks/normal_dist_time_img.php?usr_id=".$_GET['usr_id']."&chapitre_media_id=".$_GET['chapitre_media_id']."\" >".$_LANG['distribution_of_time']."</a><br />";
                
                $module_content .= "<a href=\"../../modules/marks/attempts_graphic.php?usr_id=".$_GET['usr_id']."&chapitre_media_id=".$_GET['chapitre_media_id']."\" >".$_LANG['attempts_graphic']."</a><br />";
...
else//all marks for this exercice
{
	...
	while($f = $rs->FetchRow())
	{
		...
		{
                        $tableX []= array(retournerHref("../../modules/marks/main.php?chapitre_media_id=".$_GET['chapitre_media_id']."&usr_id=".$f['usr_id']."&join",
                        $f['usr_name']));
