...
$_GET['image'] = $_LANG['flash_marks'];	

$query = "SELECT 
points_obtenu/points_max*100 AS value
FROM
...
and
time_stamp_end>time_stamp_start AND
...
)
{
        ...
        ".$_OPTIONS['table_prefix'].$_OPTIONS['tables']['inode_elements']."
        WHERE
         ".$_OPTIONS['table_prefix'].$_OPTIONS['tables']['inode_elements'].".contenet_type = '3'
         and
          ".$_OPTIONS['table_prefix'].$_OPTIONS['tables']['inode_elements'].".content_id =  ".$_OPTIONS['table_prefix'].$_OPTIONS['tables']['chapitre_media'].".chapitre_media_id
          and
