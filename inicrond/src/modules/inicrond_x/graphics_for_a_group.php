...
)
{
        ...
        while($fetch_result = $rs->FetchRow())
        {
                ...
                $tableau []= array("<a href=\"".__INICROND_INCLUDE_PATH__."modules/members/one.php?usr_id=".$fetch_result['usr_id']."&cours_id=$cours_id\">".$fetch_result['usr_name']."</a>", $fetch_result['usr_nom'], $fetch_result['usr_prenom']);  
