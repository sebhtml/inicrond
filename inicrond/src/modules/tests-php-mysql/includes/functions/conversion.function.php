...
if(__INICROND_INCLUDED__)
{
	...
	function question_2_cours($question_id)
	{
	...
	function answer_2_cours($answer_id)
	{
                if(!isset($answer_id))
                {
                        return FALSE;
	...
	function multiple_short_answer_2_cours($short_answer_id)
	{
	...
	function multiple_short_answer_2_test($short_answer_id)
	{
                if(!isset($short_answer_id))
                {
                        return FALSE;
