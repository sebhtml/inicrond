...

{
	...
	if(isset($_POST["envoi"]))//update le test
	{
		...
		";
                ...
                //$select->SET_default_VALUE($fetch_result["chapitre_id"]);
                ...
                while($fetch_result = $rs->FetchRow())  
                {
                        ...
                        elseif($fetch_result["q_type"] == 3)
                        {
                                ...
                                */
                                ...
                                while($fetch_result_2 = $query_result_2->FetchRow())
                                {
                                        ...
                                        $select = new Select();
                                        $select->set_name("short_answer_id=".$fetch_result_2["short_answer_id"]."&is_good_flag");
                        ...
                        elseif($fetch_result["q_type"] == 2)
                        {
                                ...
                                /*
                                chapitre_media_id SMALLINT UNSIGNED AUTO_INCREMENT,
                                PRIMARY KEY (chapitre_media_id),
                                
                                chapitre_media_numero SMALLINT UNSIGNED NOT NULL,
                                ...
                                */
                                ...
                                AND
                                ".$_OPTIONS["table_prefix"].$_OPTIONS["tables"]["tests"].".cours_id=".$_OPTIONS["table_prefix"].$_OPTIONS["tables"]["chapitre_media"].".cours_id
