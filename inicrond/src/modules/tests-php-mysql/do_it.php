...
include __INICROND_INCLUDE_PATH__."modules/tests-results/includes/functions/conversion.function.php";//conversions...
//peut faire un test.
...
//verify here...
is_in_inode_group($_SESSION['usr_id'], test_id_2_inode_id($_GET['test_id']))
)
{
        ...
        if(!isset($_POST["envoi"]))//formulaire...
        {
                ...
                die(count($exercices[0]));
                */


                if($Q_RANDOM_FLAG AND
                sizeof($exercices) > 1
                )//il y a t il des questions
                //est-ce que l'on m�ange...
                {
                        $exercices = at_random($exercices);//m�ange les exercices...

                }
                /*
                echo nl2br(print_r($exercices, TRUE));
                exit();
                ...
                */
                ...
                //while($fetch_result = array_pop($exercices))//pop un # num�o d'exercice...
                {
                        ...
                        //echo nl2br(print_r($fetch_result, TRUE));
                        ...
                        if($fetch_result['q_type'] == 0)
                        {
                                ...
                                */
                                ...
                                if($A_RANDOM_FLAG AND
                                count($answers) > 1//il y a t il des r�onses...
                                )//est-ce que l'on m�ange...
                                {
                        ...
                        {
                                $question["flash"] .= retournerHref("javascript:popup('../../modules/course_media/flash.php?chapitre_media_id=".$tmp['chapitre_media_id']."&question_ordering_id=".$question_ordering_id."', 790, 590)",
        ...
        }//fin de la v�ificaiton de l'auteur.
