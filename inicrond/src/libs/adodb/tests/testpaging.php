...
$driver = 'oci8';
$query = 'select  ID, firstname as "First Name", lastname as "Last Name" from adoxyz  order  by  id';
//$query = 'select count(*),firstname from adoxyz group by firstname order by 2 ';
$query = 'select distinct firstname, lastname from adoxyz  order  by  firstname';
