...
define("PHPMATH_DIR", dirname(__FILE__).DIRECTORY_SEPARATOR);

include PHPMATH_DIR."Distribution.php";
...
class SimpleLinearRegression {
  ...
  function SimpleLinearRegression($X, $Y, $ConfidenceInterval = 0.95) {
  ...
  /*
  Dude, this is ugly, this method was there twice...
  --sebhtml.
  function getStudentProb($T, $df) {    
    $Probability = 0.0;   
    $cmd = "echo 'dt($T, $df)' | $this->RPath --slave";   
